<template>
    <el-container>
            <el-header>
                <el-menu default-active="/labeldetail" class="el-menu-demo" mode="horizontal" @select="handleSelect" background-color="#545c64" text-color="#fff" active-text-color="#5fb878" router>
                    <el-menu-item index="/">
        ...
        <el-container class="mainlocationl">
            <div class="maincontainerl">
                <div class="contentcardl animate__animated animate__fadeInLeft" v-for="item in articlelist" :key="item.articleID" @click="detaillink(item.articleID)">
                    <div class="left">
                    <div class="lefttop">
...
.el-menu-demo{
  ...
  .contentcardl .left .lefttop .titlelink:hover{
      cursor: pointer;
      color: #1dc884;
  }
